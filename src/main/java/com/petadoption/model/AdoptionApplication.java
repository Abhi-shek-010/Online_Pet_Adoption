 ...
 * 
 * Represents an adoption application submitted by an adopter for a specific
 * pet.
...
public class AdoptionApplication {
    ...
    /**
     * Set application submission date
     * 
     * @param applicationDate timestamp of application submission
     */
